...
document.getElementById("create").onclick = async () => {
    ...
    window.location.href = `https://marimo123-sudo.github.io/kinolenta/room.html?entry_id=${entry_id}&is_main=true&tg_id=${tg_id}`;
};
...
document.getElementById("join").onclick = async () => {
    ...
    window.location.href = `https://marimo123-sudo.github.io/kinolenta/room.html?entry_id=${entry_id}&is_main=false&tg_id=${tg_id}`;
};
